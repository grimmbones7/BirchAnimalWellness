...
export default function CatServices() {
  return (
    <div className="container mx-auto px-4">
      <HeaderOverlay title="For Your Cat" backgroundImage="/Headerbanner/lightwood.png" />
      ...
      <div className="space-y-12">
        ...
        <div className="bg-gray-100 p-4 sm:p-8 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/2">
              <Image
                src="/foryourcat/iridology.png"
                alt="Close-up of a cat's eye"
                width={800}
                height={600}
                layout="responsive"
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-between">
              <div>
                <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Iridology</h2>
                <p className="mb-4">
                  Iridology was discovered by Hippocrates over 2500 years ago, and was modernized by Bernard Jensen in
                  1979. Iridology is the ancient science of analyzing the fiber structure, colour and marking of the
                  iris of the eye. The iris records information about the emotional and physical state and function of
                  every organ and gland in the body, as well as levels of inflammation and toxicity.
                </p>
                <p className="mb-4">
                  A major advantage of this natural therapy is that changes record in the iris years before the physical
                  symptoms actually develop. Therefore, it can be used as an early indicator, as well as a marker for
                ...
                <p>
                  ...
                  of medicine. When Iridology is applied to animals, it can be used to: assess the fitness of pets
                  before adoption or breeding, assess rescued animals with no known background, and determine if there
                  is an underlying physical issue causing a behavioural problem.
                </p>
              </div>
        ...
        <div className="bg-gray-100 p-4 sm:p-8 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/2 flex flex-col justify-between">
              <div>
                <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Acupressure</h2>
                <p className="mb-4">
                  ...
                  entire system. The main belief behind of this type of medicine is that our bodies can heal themselves
                  we just have to nudge them back towards balance.
                </p>
                <p className="mb-4">
                  Acupressure is a form of TCM that aims to clear blockages in the energetic channels throughout the
                  body's by applying light pressure to acupoints to restore the harmonious flow of Chi. The body's Chi
                  can be disrupted, weakened, or blocked if there is imbalance between the pairs of yin and yang organs
                  or between the Five Elements. There are many categories of acupressure points, some that are more
                  powerful, some govern regions or systems of the body, and others that (re)connect organ systems.
                </p>
                <p className="mb-4">
                  Imbalances can display as: behavioural problems such as separation anxiety, difficulty concentrating,
                  or aggression; physical problems such as joint pain, digestive issues, itchy skin, or other chronic
                  wellness issues.
                </p>
                <p>
                  ...
                  create numerous imbalances in any of the Elements. For example, when moving from Spring to Summer,
                  Fire gets stronger and Wood is weakened.
                </p>
              </div>
              <div className="mt-8 bg-white p-4 rounded-lg shadow">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            ...
            <div className="w-full md:w-1/2">
              <Image
                src="/foryourcat/acupressure.png"
                alt="Feline Acupressure Meridian Chart"
                width={800}
                height={600}
                layout="responsive"
                className="rounded-lg"
        ...
        <div className="bg-gray-100 p-4 sm:p-8 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/2">
              <Image
                src="/foryourcat/floweressences.png"
        ...
        <div className="bg-gray-100 p-4 sm:p-8 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/2 flex flex-col justify-between">
              <div>
                <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Cold Laser Therapy (LLLT)</h2>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  ...
                  source of light (scattered beam) as compared to the cold laser which is a coherent light source
                  (focused beam). Clinical studies have shown that a focused beam penetrates much deeper into the
                  tissues which allows for a more complete healing process.
                </p>
              </div>
              <div className="mt-8 bg-white p-4 rounded-lg shadow">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                  <div className="mb-4 sm:mb-0">
                    <h3 className="font-semibold">Session Length:</h3>
                    <p>It depends on the size of the area I'm working, but typically ~30 minutes.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold">Cost:</h3>
                    <p>$65</p>
            ...
            <div className="w-full md:w-1/2">
              <Image
                src="/foryourcat/coldlaser.png"
                alt="Applying cold laser therapy to a cat's leg"
                width={800}
                height={600}
                layout="responsive"
                className="rounded-lg"
        ...
        <div className="bg-gray-100 p-4 sm:p-8 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/2">
              <Image
                src="/foryourcat/reiki.png"
                alt="cat grazing in a field"
                width={800}
                height={600}
                layout="responsive"
                className="rounded-lg"
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-between">
              <div>
                ...
                <p className="mb-4">
                  Reiki is a Japanese healing technique based on the principle that the therapist can channel energy
                  into the patient's body by means of touch, to activate the natural healing processes of the patient's
                  body and restore physical and emotional well-being. They do this by moving the 'Rei' or 'life force
                  energy' to parts of the body, meridians, or chakras that are unbalanced.
                </p>
                <p className="mb-4">
                  "Reiki is an ideal alternative therapy for animals because it is gentle, painless, non-invasive and
                  stress free. It heals at all levels of an animal's being: physical, mental, emotional, and spiritual.
                  It can be given at any distance, under any circumstances to treat any problem. It is a powerful
                  holistic therapy that always goes to the root of the problem, but causes no harm to recipient or
                  practitioner." – Kathleen Prasad
                </p>
              </div>
        ...
        <div className="bg-gray-100 p-4 sm:p-8 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/2 flex flex-col justify-between">
              <div>
                ...
                <p className="mb-4">
                  ...
                  other people or animals in it, your animal's name, age, and gender. Many pet parents also provide a
                  list of specific questions or concerns going into the session and those are discussed with the animal.
                </p>
              </div>
              <div className="mt-8 bg-white p-4 rounded-lg shadow">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            ...
            <div className="w-full md:w-1/2">
              <Image
                src="/foryourcat/animcomm.png"
                alt="Applying cold laser therapy to a car's leg"
                width={800}
                height={600}
                layout="responsive"
                className="rounded-lg"
