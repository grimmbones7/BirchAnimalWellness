            ...
            <div className="w-full md:w-1/2 flex flex-col justify-between">
              <div>
                ...
                <p className="mb-4">
                  ...
                  body by applying light pressure to acupoints to restore the harmonious flow of Chi. The body's Chi can
                  be disrupted, weakened, or blocked if there is imbalance between the pairs of yin and yang organs or
                  between the Five Elements.There are many categories of acupressure points, some that are more
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-between">
              <div>
                ...
                <p className="mb-4">
                  ...
                  into the patient by means of touch, to activate the natural healing processes of the patient's body
                  and restore physical and emotional well-being. They do this by moving the 'Rei' or 'life force energy'
                  to parts of the body, meridians, or chakras that are unbalanced.
                </p>
                <p className="mb-4">
