      ...
      <div className="space-y-12">
        ...
        <div className="bg-gray-100 p-4 sm:p-8 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/2">
              <Image
                src="/foryourdog/acupressure.png"
                alt="Canine Acupressure Meridian Chart"
                width={800}
                height={600}
                layout="responsive"
                className="rounded-lg"
        ...
        <div className="bg-gray-100 p-4 sm:p-8 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/2">
              <Image
                src="/foryourdog/floweressences.png"
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/2">
              <Image
                ...
                alt="Dog looking at camera for animal communication"
                width={800}
                height={600}
                layout="responsive"
                className="rounded-lg"
