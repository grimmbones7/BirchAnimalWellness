      ...
      <div className="bg-gray-100 rounded-lg shadow-md overflow-hidden">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-2/3 p-10">
            <p className="text-3xl font-semibold mb-6">Service Area</p>
            ...
            <p className="mb-6">I now have a secondary location in Lindsay two days a week.</p>

            <p className="mb-6">
              I provide online distance therapy consults in Toronto, the GTA, throughout Ontario - or anywhere in the
              world!
            </p>
          </div>
